...
public class SamSungActivity extends AppCompatActivity {
    ...
    ArrayList<DienThoai> arrayListSamSung;
    int idDienThoai = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sam_sung_actitvity);
        AnhXa();
        GetIDLoaiDienThoai();
        ActionToolbar();
        GetDataSamSung();
    ...
    private void ActionItemViewHolder() {
        lvSamSung.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("thongTinDienThoai",arrayListSamSung.get(position));
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                CheckConnection.showToast_Short(getApplicationContext(),arrayListSamSung.get(position).getTenDienThoai());
    ...
    private void GetDataSamSung() {
        ...
        for (int i = 0 ; i < cursor.getCount(); i++)
        {
            ...
            arrayListSamSung.add(i, new DienThoai(id,tenDienThoai,heDieuHanh,manHinh,cameraTruoc,cameraSau,Chip,Ram,boNhoTrong,PIN,hinhAnh,giaTien,gioiThieu,idHangDT));
        }
        cursor.close();
    ...
    private void AnhXa() {
        ...
        lvSamSung = findViewById(R.id.listViewSamSung);
        arrayListSamSung = new ArrayList<>();
        samSungAdapter = new SamSungAdapter(getApplicationContext(),arrayListSamSung);
        lvSamSung.setAdapter(samSungAdapter);
