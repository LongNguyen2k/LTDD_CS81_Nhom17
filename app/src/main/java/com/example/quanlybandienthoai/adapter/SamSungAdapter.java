...
public class SamSungAdapter extends BaseAdapter {
    public SamSungAdapter(Context context, ArrayList<DienThoai> arrayListSamSung) {
        this.context = context;
        this.arrayListSamSung = arrayListSamSung;
    }

    private Context context;
    private ArrayList<DienThoai> arrayListSamSung;
    ...
    public Object getItem(int position) {
        return arrayListSamSung.get(position);
    }
    ...
    public ArrayList<DienThoai> getArrayListApple() {
        return arrayListSamSung;
    }

    public void setArrayListApple(ArrayList<DienThoai> arrayListSamSung) {
        this.arrayListSamSung = arrayListSamSung;
    }
}
